...
return [
    ...
    '3.0.0-beta.2.1' => function ($node, array $params) {
        /**
         * @var Config $config
         */
    ...
    '2.8.0-beta.0.3' => function ($node, array $params) {
        foreach (['x', 'y', 'scale', 'rotate', 'opacity'] as $prop) {
            ...
            if ($start != '' || $end != '') {
                ...
                Arr::set(
                    $node->props,
                    $key,
                    implode(',', [$start != '' ? $start : $default, $end != '' ? $end : $default])
                );
            }
    ...
    '2.8.0-beta.0.1' => function ($node, array $params) {
    ...
    '2.1.1.1' => function ($node, array $params) {
        /**
         * @var Config $config
         */
        $config = app(Config::class);
